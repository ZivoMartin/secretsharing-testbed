...
use super::{
    ...
    fiat_shamir::NIVSS_DOM_SEP,
    utils::{get_xpowers, get_xpowers_at_0, scalar_mult_exp},
};
use crate::crypto::crypto_lib::{hash_to_scalar, random_scalar, util};
...
impl ShareOracle {
    pub fn new(
        ...
        util::append_g1_vector(&mut t, b"", commits);
        util::append_g1_vector(&mut t, b"", public_keys);
        util::append_g1_point(&mut t, b"", aa);
        util::append_g1_vector(&mut t, b"", enc_ss);
        util::append_g1_point(&mut t, b"", bb);
        util::append_g1_vector(&mut t, b"", enc_rr);
